...
def main():
    ...
    ap.add_argument("--group-c", default="../data/raw/nvd_group_C_2026-06-29.json")
    ap.add_argument("--epss", default="../data/snapshots/epss_scores-2026-06-29.csv")
    ap.add_argument("--excluded-status", default="Deferred")
    ap.add_argument("--reference-status", default="Analyzed")
    ap.add_argument("--out-a", default="fig_survival_A_vs_C.png")
    ap.add_argument("--out-b", default="fig_survival_B_vs_C.png")
    a = ap.parse_args()
