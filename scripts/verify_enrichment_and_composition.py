...
def has_nvd_cpe(wrapper, cve):
    return len(configurations(wrapper, cve)) > 0
...
def main():
    ...
    ap.add_argument("--group-d", default="../data/raw/nvd_group_D_2026-06-29.json")
    ap.add_argument("--registry", default="../data/processed/source_registry.json")
    ap.add_argument("--kev", default="../data/snapshots/known_exploited_vulnerabilities.json")
